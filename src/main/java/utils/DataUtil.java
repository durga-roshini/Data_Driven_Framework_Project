...
public class DataUtil {
	...
	public static boolean isRunnable(MyXLSReader xls_received, String tName, String sheet){
		...
		for(int r=2;r<=rows;r++){
			...
			if(testName.equals(tName)){
				...
				String runmode1 = xls.getCellData(sheetName, "Chrome", r);
				String runmode2 = xls.getCellData(sheetName, "Edge", r);

				if(runmode1.equals("Y"))
					return true;
				else if (runmode2.equals("Y"))
					return true;
	...
	public static String getBrowserType(MyXLSReader xls_received, String tName, String sheet){
